...
\textbf{Graduate Research Fellow} \hfill {2017}%{May 2017--August 2017}
\begin{innerlist}
  
    \item[] \href{http://www.nims.go.jp/pi-ele_g/index-e.html}{$\pi$- Electronics Research Group}, \\
    %International Center for Materials Nanoarchitectonics (MANA),\\
    \href{http://www.nims.go.jp/eng/index.html}{National Institute for Materials Science (NIMS) (\begin{CJK}{UTF8}{min}国立研究開発法人物質・材料研究機構\end{CJK})},\\
    Tsukuba, Ibaraki Prefecture, Japan\\
    Supervisor: Kazuhito Tsukagoshi, Ph.D.\\
\end{innerlist}
...
%\phantomsection
%\bibliographystyle{plain}
%\bibliography{refs/kraig_refs}
%\nocite{chamlagain2016substrate_conference}
...
Nanofabrication:
\begin{innerlist}
    \item[] Atomic Force Microscopy (AFM), Electron Beam Lithography, Photolithography, \href{http://www.autodesk.com/solutions/cad-software}{Computer-Aided Design (CAD)}, Scanning Electron Microscopy (SEM), General Clean Room Abilities, Physics Vapor Depsoition (PVD), Electron Beam Deposition, Atom Layer Deposition (ALD), Plasma Etching, Reactive Ion Etching.
\end{innerlist}
...
\begin{innerlist}
    \item[] \href{https://www.latex-project.org/}{\TeX}/\LaTeX, \BibTeX, Microsoft Office, OpenOffice, LibreOffice, \href{https://www.gimp.org/}{GIMP}, \href{https://inkscape.org/en/}{InkScape}
\end{innerlist}
...
\begin{innerlist}
    \item[] Advanced Condensed Matter Physics
    \item[] Methods of Engineering Analysis II
