...
Detroit, MI 48201     & \email{fp1361@wayne.edu}\\
\end{tabular}
...
\item[] Ph.D.,
        \href{http://physics.clas.wayne.edu/}
             {Physics},
             \emph{Expected:} May 2018
        \begin{innerlist}
        \item Thesis Topic: \emph{$\ldots$}
        \item Advisor:
...
\item[] B.S.,
        \href{http://www.pa.msu.edu/}
             {Physics}, 2014
\item[] B.S.,
        \href{http://www.pa.msu.edu/astro/Astronomy.html}
             {Astrophysics}, 2014
        %\begin{innerlist}
...
\textbf{Graduate Research Assistant} \hfill {May 2015--Present}
\begin{innerlist}
    
    \item[] Nano Fabrication and Electron Transport Laboratory,\\
...
\item[] High Resolution Array Group (HIRA): SAMURAI-TPC Project\\
...
\vspace{-.1275in}
\begin{bibsection}
    \item Chamlagain, B., Perera, M., Chuang, H.J., Bowman, A., Rijal, U., {\bf Andrews, K.}, Klesko, J., Winter, C., Zhou, Z. ``Substrate dependence of Hall and Field-effect mobilities in few-layer $\mathrm{MoS}_2$ field-effect transistors." \emph{Manuscript in preperation}, 2016.
...
Fabrication, Data Acquisition, Test, and Measurement:
%
\begin{innerlist}
    \item LabView, Atomic Force Microscopy (AFM), Electron Beam Lithography, Photolithography, Computer-Aided Design (CAD), Scanning Tunneling Microscopy (STM), Transmission Electron Microscopy (TEM), Scanning Electron Microscopy (SEM), and others
\end{innerlist}
...
%
\begin{innerlist}
    \item C, C$+$$+$, Fortran, GNU make, \Matlab, Mathematica, Python, UNIX shell scripting, and Visual Basic
\end{innerlist}
...
%
\begin{innerlist}
    \item Microsoft Windows family, Apple OS X, Linux OS
\end{innerlist}
...
\begin{innerlist}
    ...
    \item Microsoft Office, OpenOffice, LibreOffice
    \item GIMP, InkScape
\end{innerlist}
