...
\item[] Ph.D.,
        \href{http://physics.clas.wayne.edu/}
             {Physics},
             \emph{Expected:} Fall 2018, GPA: 3.50/4.00
        \begin{innerlist}
...
\item[] B.S.,
        \href{http://www.pa.msu.edu/}
             {Physics}, May 2014, GPA: 3.25/4.00
\item[] B.S.,
...
Fabrication, Data Acquisition, Testing, and Measurement:
%
\begin{innerlist}
    \item LabView, Atomic Force Microscopy (AFM), Electron Beam Lithography, Photolithography, Computer-Aided Design (CAD), Scanning Electron Microscopy (SEM), and others
\end{innerlist}
